# E3T1 — Global error boundary and logging

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ECHO

Implement a global error handler in src/handlers/error.ts to:
- Catch unhandled exceptions in update handlers.
- Log full exception details to stderr with ERROR level.
- Send a user-facing message 'An internal error occurred.' when appropriate.
