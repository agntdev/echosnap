# E2T1 — /start command with welcome message

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ECHO

Implement the /start command in src/handlers/start.ts. The command should:
- Reply with the message: 'Hi — I'm EchoSnap. Send /echo <text> and I'll repeat it back to you.'
- Write a BotSpec test in tests/specs/start.json and register the command in tests/commands.json.
